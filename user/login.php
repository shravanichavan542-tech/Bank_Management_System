        ...
        <div class="container">
            <div class="card login-card">
                <div class="row no-gutters">
                    <div class="col-md-5">
                        <img src="https://buzznigeria.com/wp-content/uploads/2013/12/Skye-Bank.jpg" alt="login" class="login-card-img" style="object-fit: fill;">
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
                            ...
                            <p class="login-card-footer-text">Don't have an account? <a href="../user/CreateAccount.php" class="text-reset">Create New Account</a></p>
